    ...
    <div class="modal fade" id="update-modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-3 shadow">
                ...
                <form id="update-form" method="POST" action="{{ route('admin.students.update') }}">
                    @csrf
    ...
    <div class="card shadow-sm border-0 mb-4 rounded-4">
        ...
        <div class="card-body pt-0 px-4 pb-4">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <input type="date" id="search-date" class="form-control form-control-lg search-input"
    ...
    <script>
        ...
        $(document).ready(function() {
            $(document).on('click', '.btn-update', function(e) {
                ...
                var birth_date = $(this).data('date');
                var profile_image = $(this).data('img');
                $('#id').val(id);
                $('#name').val(name);
                $('#email').val(email);
                $('#gender').val(gender);
