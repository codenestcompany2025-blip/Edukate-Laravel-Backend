            ...
            <div class="row">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{ asset('site/img/about.jpg') }}"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{ asset('site/img/feature.jpg') }}"
                            style="object-fit: cover;">
                    </div>
                </div>
            </div>
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="bg-white p-5">
                            ...
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                <img class="img-fluid mr-4" src="{{ asset('site/img/testimonial-2.jpg') }}"
                                    alt="">
                                <div>
                                    <h5>Student Name</h5>
                        ...
                        <div class="bg-white p-5">
                            ...
                            <p>Sed et elitr ipsum labore dolor diam, ipsum duo vero sed sit est est ipsum eos clita est
                                ...
                                sed stet amet elitr duo lorem</p>
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                <img class="img-fluid mr-4" src="{{ asset('site/img/testimonial-1.jpg') }}"
                                    alt="">
                                <div>
                                    <h5>Student Name</h5>
                                    <span>Web Design</span>
