...
@section('title', 'Edukate - Course Detail')
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <img class="img-fluid rounded mb-4" style="width:730px; height:410px; object-fit: cover;"
                            src="{{ asset('uploads/images/courses/' . $course->image->url) }}" alt="Image">
                    ...
                    <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                        @foreach ($relatedCourses as $c)
                            <a class="courses-list-item position-relative d-block overflow-hidden mb-2"
                                href="{{ route('site.detail', $c->id) }}">
                                <img class="img-fluid" src="{{ asset('uploads/images/courses/' . $c->image->url) }}"
                                    alt="">
                                    ...
                                    <div class="border-top w-100 mt-3">
                                        <div class="d-flex justify-content-between p-4">
                                            <span class="text-white"><i
                                                    class="fa fa-user mr-2"></i>{{ $c->instructor->name }}</span>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        ...
                        <div class="d-flex justify-content-between border-bottom px-4">
                            ...
                            <h6 class="text-white my-3">{{ $course->lectures()->count() }}</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">Duration</h6>
                            <h6 class="text-white my-3">{{ number_format($course->duration, 2) }} Hrs</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                    ...
                    <div class="mb-5">
                        ...
                        @foreach ($recentCourses as $c)
                            <a class="d-flex align-items-center text-decoration-none mb-4" href="">
                                <img class="img-fluid rounded" src="{{ asset('uploads/images/courses/' . $c->image->url) }}" style="width:80px; height:80px;"
                                    alt="">
                                <div class="pl-3">
                                    <h6>{{ $c->name }}</h6>
                                    <div class="d-flex">
                                        <small class="text-body mr-3"><i class="fa fa-user text-primary mr-2"></i>{{ $c->instructor->name }}</small>
                        ...
                        @endforeach
                        {{-- <a class="d-flex align-items-center text-decoration-none mb-4" href="">
                            <img class="img-fluid rounded" src="{{ asset('site/img/courses-80x80.jpg') }}" alt="">
                            <div class="pl-3">
                        ...
                        <a class="d-flex align-items-center text-decoration-none mb-4" href="">
                            <img class="img-fluid rounded" src="{{ asset('site/img/courses-80x80.jpg') }}"
                                alt="">
                            <div class="pl-3">
                                <h6>Web design & development courses for beginners</h6>
                                <div class="d-flex">
