                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="skill_level" id="skill_level"
                            ...
                            <option value="beginner"
                                {{ old('skill_level', $course->skill_level) == 'beginner' ? 'selected' : '' }}>Beginner
                            </option>
                            <option value="intermediate"
                                {{ old('skill_level', $course->skill_level) == 'intermediate' ? 'selected' : '' }}>
                                Intermediate</option>
                            <option value="advanced"
                                {{ old('skill_level', $course->skill_level) == 'advanced' ? 'selected' : '' }}>Advanced
                            </option>
                        </select>
                        @error('skill_level')
                            <div class="invalid-feedback">{{ $message }}</div>
