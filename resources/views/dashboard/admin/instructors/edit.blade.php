                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="qualification" class="form-control">
                            <option value="d"
                                {{ old('qualification', $instructor->qualification) == 'd' ? 'selected' : '' }}>Diploma
                            </option>
                            <option value="b"
                                {{ old('qualification', $instructor->qualification) == 'b' ? 'selected' : '' }}>Bachelor
                            </option>
                            <option value="m"
                                {{ old('qualification', $instructor->qualification) == 'm' ? 'selected' : '' }}>Master
                            </option>
                            <option value="dr"
                                {{ old('qualification', $instructor->qualification) == 'dr' ? 'selected' : '' }}>Doctor
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="gender" class="form-control">
                            <option value="m" {{ old('gender', $instructor->gender) == 'm' ? 'selected' : '' }}>Male
                            </option>
                            <option value="f" {{ old('gender', $instructor->gender) == 'f' ? 'selected' : '' }}>Female
                            </option>
                        </select>
                    </div>
                </div>
