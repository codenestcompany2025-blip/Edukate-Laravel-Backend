...
@section('content')
    ...
    <div class="card custom-card shadow-sm mb-4">
        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-6">
                    <p><i class="fas fa-envelope mr-2 text-muted m"></i><strong>Email:</strong> {{ $instructor->email }}</p>
                    <p><i class="fas fa-book-open mr-2 text-muted"></i><strong>Major:</strong> {{ $instructor->major }}</p>
