...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="page-title">Add New Lecture</h1>
    ...
    <div class="card custom-card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('instructor.course.lectures.store', $course) }}" method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="order" id="order"
                            class="form-control @error('order') is-invalid @enderror" value="{{ old('order') }}" required>
