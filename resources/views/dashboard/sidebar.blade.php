...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item active">
        <a class="nav-link" href="{{ route($guard . '.dashboard') }}">
            <i class="fas fa-fw fa-tachometer-alt"></i>
            <span>Dashboard</span></a>
    </li>
    ...
    @if ($guard == 'admin')
        ...
        <li class="nav-item">
            ...
            <div id="collapseStudentCourse" class="collapse" aria-labelledby="headingStudentCourse"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{ route('admin.student_courses.index') }}">All Students -
                        Courses</a>
                    <a class="collapse-item" href="{{ route('admin.student_courses.create') }}">Add Student -
                        Course</a>
                </div>
            </div>
        </li>
    ...
    @elseif ($guard == 'instructor')
     ...
     <li class="nav-item">
         ...
         <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="{{ route('instructor.courses') }}">All Courses</a>
             </div>
         </div>
     </li>
